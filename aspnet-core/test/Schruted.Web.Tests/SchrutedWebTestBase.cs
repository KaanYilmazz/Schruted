...
{
    public abstract class SchrutedWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SchrutedWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SchrutedWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SchrutedDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SchrutedDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SchrutedDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SchrutedDbContext, Task<T>> func)
        {
            T result;
